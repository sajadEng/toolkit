...
function Keypad({numberKeyClickHandler, equalKeyClickHandler, clearBtnCLickHandler}) {
    ...
    return (
        <div className="btns-div">
            ...
            <button href="/" onClick={event => navigate('/toolkit')} className="minor-btns" style={{backgroundColor: 'white', boxShadow: 'none'}}><img src="/images/home-icon.png" width='35px' alt="H" /></button>
		</div>
    )
}
